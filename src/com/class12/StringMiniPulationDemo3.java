...
public class StringMiniPulationDemo3 {
	...
	public static void main(String[] args) {
         ...
         * with leading and trailing white space omitted.
         */
        String str6=" How are you? ";
        System.out.println(str6.trim());
        
        System.out.println("@@@@@@@@@@@@@@@@@");
        /*This method return the character located at the String's specified index
        ...
        System.out.println(str8.indexOf('e',4));//-1 the character does not occur
	}
